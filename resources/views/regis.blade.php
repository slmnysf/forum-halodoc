    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <form class="form-auth-small" action="/postregis" method="POST">
            ...
            <div class="form-group">
                ...
                <input name="name" type="text" class="form-control" id="regis-name" placeholder="Nama">
            </div>
            <div class="form-group">
                <label for="regis-email" class="control-label sr-only">Email address</label>
                <input name="email" type="email" class="form-control" id="regis-email" placeholder="Email">
            </div>
            <div class="form-group">
                <label for="regis-password" class="control-label sr-only">Password</label>
                <input name="password" type="password" class="form-control" id="regis-password" placeholder="Password">
            </div>
